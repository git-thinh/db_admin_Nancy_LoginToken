...
namespace host
{
    public class meter1Controller : ApiController
    {

        [HttpGet]
        public HttpResponseMessage Get()
        {
            string s = typeof(meter1Controller).Name + ":" + DateTime.Now.ToString();
        ...
        public HttpResponseMessage PostData(dynamic[] items)
        {
            ...
            try
            {
                ...
                db_meter.add_Items(ls, d1_pha._1pha);
                s = typeof(meter1Controller).Name + " [" + ls.Length.ToString() + "] : OK " + DateTime.Now.ToString();
            }
            catch (Exception ex) { }
