namespace Nancy
{
    public static class exUri
    {
        public static string getDomain(this System.Uri uri)
        {
            if (uri != null)
...
namespace Nancy
{
    ...
    public sealed class Url : ICloneable
    {
        ...
        {
            var uri = new Uri(url);
            this.HostName = uri.Host.Replace("www.", "");
        ...
        public string HostName { get { return getDomain; } set { getDomain = value.Replace("www.", ""); } }
